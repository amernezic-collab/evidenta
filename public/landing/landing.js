...
(function () {
  ...
  var T = {
    bs: { soon: "USKORO", h1: "Projekti usklađenosti na jednom mjestu.", lead: "Evidenta vodi projekte za ISO 27001, ISO 9001, NIS2 i TISAX: od gap analize i procjene rizika do audita, izvještaja za upravu i registara koje traži auditor.",
      cta: "Javite nam se", note: "Već je koristimo na projektima s klijentima. Samostalna verzija za firme stiže uskoro.", cap: "Sažetak za upravu, prikaz s primjer podacima.", alt: "Evidenta: sažetak za upravu", fh: "Šta Evidenta radi", by: "Razvija SCE Assurance, Sarajevo", title: "Evidenta · uskoro",
    ...
    en: { soon: "COMING SOON", h1: "Compliance projects in one place.", lead: "Evidenta runs projects for ISO 27001, ISO 9001, NIS2 and TISAX: from gap analysis and risk assessment to audits, management reports and the registers your auditor asks for.",
      cta: "Get in touch", note: "We already use it on client projects. A stand-alone version for companies is coming soon.", cap: "Management summary, shown with sample data.", alt: "Evidenta: management summary", fh: "What Evidenta does", by: "Built by SCE Assurance, Sarajevo", title: "Evidenta · coming soon",
    ...
    de: { soon: "DEMNÄCHST", h1: "Compliance-Projekte an einem Ort.", lead: "Evidenta steuert Projekte für ISO 27001, ISO 9001, NIS2 und TISAX: von der Gap-Analyse und Risikobeurteilung bis zu Audits, Managementberichten und den Registern, die der Auditor verlangt.",
      cta: "Kontakt aufnehmen", note: "Wir setzen sie bereits in Kundenprojekten ein. Eine eigenständige Version für Unternehmen folgt in Kürze.", cap: "Managementübersicht, dargestellt mit Beispieldaten.", alt: "Evidenta: Managementübersicht", fh: "Was Evidenta kann", by: "Entwickelt von SCE Assurance, Sarajevo", title: "Evidenta · demnächst",
